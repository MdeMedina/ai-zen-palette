...
These three are related — together they're the difference between "Good" (28) and "Excellent" (36+), and would likely need a product decision (does this gate _have_ a recovery flow?) before a future `/impeccable harden` pass on this page.
